...
export function PaginaDashboard() {
    ...
    return (_jsxs("section", { className: "space-y-5", children: [_jsx("div", { className: "rounded-2xl border border-slate-200 bg-gradient-to-r from-slate-50 via-white to-slate-50 p-4 sm:p-5", children: _jsx(PageHeader, { title: "Dashboard", description: `Resumen general del sistema RRHH · ${new Date().toLocaleDateString("es-PE", { weekday: "long", day: "2-digit", month: "long", year: "numeric" })}`, action: _jsxs(_Fragment, { children: [_jsxs(Link, { to: "/app/employees", className: "inline-flex h-10 items-center gap-2 rounded-lg bg-brand-600 px-4 text-[13px] font-semibold text-white hover:bg-brand-700", children: [_jsx(UserPlus, { className: "size-4" }), "Nuevo empleado"] }), _jsxs(Link, { to: "/app/attendance", className: "inline-flex h-10 items-center gap-2 rounded-lg border border-blue-200 bg-white px-4 text-[13px] font-semibold text-blue-700 hover:bg-blue-50", children: [_jsx(Clock3, { className: "size-4" }), "Registrar asistencia"] }), _jsxs(Link, { to: "/app/vacations", className: "inline-flex h-10 items-center gap-2 rounded-lg border border-violet-200 bg-white px-4 text-[13px] font-semibold text-violet-700 hover:bg-violet-50", children: [_jsx(FileCheck2, { className: "size-4" }), "Aprobar solicitudes"] }), _jsxs(Link, { to: "/app/reports", className: "inline-flex h-10 items-center gap-2 rounded-lg border border-slate-200 bg-white px-4 text-[13px] font-semibold text-slate-700 hover:bg-slate-50", children: [_jsx(ClipboardList, { className: "size-4" }), "Ver reportes"] })] }) }) }), _jsxs("div", { className: "grid gap-3 sm:grid-cols-2 lg:grid-cols-6", children: [_jsx(Kpi, { title: "Empleados totales", value: fmt(analytics?.totalEmployees), sub: "En toda la organizacion", icon: Users, tone: "teal", badge: "Global" }), _jsx(Kpi, { title: "Activos", value: fmt(analytics?.activeEmployees), sub: "Con vinculo vigente", icon: UserCheck, tone: "green", badge: safePercent((analytics?.activeEmployees ?? 0) / Math.max(analytics?.totalEmployees ?? 1, 1)) }), _jsx(Kpi, { title: "Nuevos este mes", value: fmt(analytics?.newHiresThisMonth), sub: "Altas del mes", icon: UserPlus, tone: "blue", badge: "Mes" }), _jsx(Kpi, { title: "Bajas este mes", value: fmt(analytics?.terminationsThisMonth), sub: "Bajas del mes", icon: UserRoundMinus, tone: "rose", badge: "Mes" }), _jsx(Kpi, { title: "Asistencia hoy", value: safePercent(analytics?.attendanceRate), sub: `${fmt(attendance?.present)} registros`, icon: Clock3, tone: "amber", badge: `Tardanza ${safePercent(analytics?.lateRate)}` }), _jsx(Kpi, { title: "Pendientes", value: fmt(totalPending), sub: "Solicitudes por revisar", icon: FileCheck2, tone: "violet", badge: "Prioridad" })] }), _jsxs("div", { className: "grid gap-3 lg:grid-cols-3", children: [_jsxs(Card, { className: "border-slate-200 min-h-[360px]", children: [_jsx(CardHeader, { className: "pb-2", children: _jsxs(CardTitle, { className: "flex items-center gap-2 text-slate-800", children: [_jsx(FileCheck2, { className: "size-4 text-violet-600" }), "Pendientes de aprobacion"] }) }), _jsxs(CardContent, { className: "space-y-2 py-3", children: [pending.map((p) => (_jsxs("div", { className: "grid grid-cols-[1fr_auto_auto] items-center gap-3 rounded-xl border border-slate-100 bg-slate-50/60 px-3 py-2.5", children: [_jsxs("div", { children: [_jsx("p", { className: "text-sm font-semibold text-slate-800", children: p.label }), _jsx("p", { className: "text-[11px] text-slate-500", children: p.detail })] }), _jsx("span", { className: "text-xl font-extrabold text-slate-900", children: fmt(p.value) }), _jsxs(Link, { to: "/app/reports", className: "inline-flex items-center gap-1 text-[12px] font-semibold text-brand-600 hover:text-brand-700", children: ["Revisar", _jsx(ArrowRight, { className: "size-3.5" })] })] }, p.label))), _jsxs(Link, { to: "/app/reports", className: "inline-flex w-full items-center justify-center gap-2 rounded-xl border border-orange-200 bg-orange-50 px-3 py-2 text-[12px] font-semibold text-orange-700 hover:bg-orange-100", children: ["Ver todas las solicitudes", _jsx(ArrowRight, { className: "size-3.5" })] })] })] }), _jsxs(Card, { className: "border-slate-200 min-h-[360px]", children: [_jsx(CardHeader, { className: "pb-2", children: _jsxs(CardTitle, { className: "flex items-center justify-between text-slate-800", children: [_jsxs("span", { className: "flex items-center gap-2", children: [_jsx(Activity, { className: "size-4 text-emerald-600" }), "Actividad reciente"] }), _jsx(Link, { to: "/app/audit-log", className: "text-[12px] font-semibold text-brand-600", children: "Ver todo" })] }) }), _jsx(CardContent, { className: "space-y-3 py-3", children: [
                                ...
                                ].map((item, i, arr) => (_jsxs("div", { className: "grid grid-cols-[auto_1fr] gap-3", children: [_jsxs("div", { className: "flex flex-col items-center", children: [_jsx("span", { className: `mt-0.5 flex size-7 items-center justify-center rounded-full ${item.c}`, children: _jsx(Circle, { className: "size-2.5 fill-current" }) }), i < arr.length - 1 && _jsx("span", { className: "mt-1 h-full min-h-8 w-px bg-slate-200" })] }), _jsxs("div", { className: "rounded-xl border border-slate-100 px-3 py-2.5", children: [_jsxs("div", { className: "flex items-center justify-between gap-2", children: [_jsx("p", { className: "text-sm font-semibold text-slate-800", children: item.title }), _jsx("span", { className: "text-[11px] font-semibold text-slate-500", children: item.t })] }), _jsx("p", { className: "mt-1 text-[12px] text-slate-500", children: item.d })] })] }, item.title))) })] }), _jsxs(Card, { className: "border-slate-200 min-h-[360px]", children: [_jsx(CardHeader, { className: "pb-2", children: _jsxs(CardTitle, { className: "flex items-center justify-between text-slate-800", children: [_jsxs("span", { className: "flex items-center gap-2", children: [_jsx(CalendarClock, { className: "size-4 text-amber-600" }), "Proximos eventos"] }), _jsx(Link, { to: "/app/calendar", className: "text-[12px] font-semibold text-brand-600", children: "Ver calendario" })] }) }), _jsx(CardContent, { className: "space-y-2 py-3", children: events.length ? events.map((ev, i) => {
                                    const tone = eventTone(ev.type);
                                    const Icon = tone.icon;
                                    return (_jsxs("div", { className: "grid grid-cols-[auto_1fr_auto] items-center gap-3 rounded-xl border border-slate-100 bg-slate-50/60 px-3 py-2.5", children: [_jsx("span", { className: `flex size-8 items-center justify-center rounded-lg ${tone.color}`, children: _jsx(Icon, { className: "size-4" }) }), _jsxs("div", { className: "min-w-0", children: [_jsx("p", { className: "truncate text-sm font-semibold text-slate-800", children: ev.title }), _jsx("p", { className: "truncate text-[11px] text-slate-500", children: ev.employeeName ?? tone.label })] }), _jsx("span", { className: "text-[11px] font-bold text-slate-700", children: ev.startDate })] }, `${ev.title}-${i}`));
                                }) : _jsx("p", { className: "py-8 text-center text-sm text-slate-400", children: "Sin eventos proximos." }) })] })] }), _jsxs("div", { className: "grid gap-3 lg:grid-cols-2", children: [_jsxs(Card, { className: "border-slate-200 min-h-[360px]", children: [_jsx(CardHeader, { className: "pb-2", children: _jsxs(CardTitle, { className: "flex items-center justify-between text-slate-800", children: [_jsxs("span", { className: "flex items-center gap-2", children: [_jsx(MapPin, { className: "size-4 text-teal-600" }), "Distribucion del personal"] }), _jsx(Link, { to: "/app/analytics", className: "text-[12px] font-semibold text-brand-600", children: "Ver distribucion completa" })] }) }), _jsxs(CardContent, { className: "grid gap-4 lg:grid-cols-[220px_1fr]", children: [_jsx("div", { className: "mx-auto grid place-items-center", children: donut.length ? _jsx("div", { className: "relative size-[186px] rounded-full", style: { background: `conic-gradient(${donut.map((s) => `${s.color} ${s.start.toFixed(2)}% ${(s.start + s.pct).toFixed(2)}%`).join(", ")})` }, children: _jsxs("div", { className: "absolute inset-[24px] grid place-items-center rounded-full bg-white shadow-inner", children: [_jsx("p", { className: "text-3xl font-extrabold text-slate-900", children: fmt(totalArea) }), _jsx("p", { className: "text-[11px] font-semibold uppercase tracking-wide text-slate-500", children: "Total" })] }) }) : _jsx("p", { className: "text-sm text-slate-400", children: "Sin datos" }) }), _jsx("div", { className: "space-y-2", children: donut.map((a) => _jsxs("div", { className: "grid grid-cols-[auto_1fr_auto_auto] items-center gap-2 rounded-md px-2 py-1.5 hover:bg-slate-50", children: [_jsx("span", { className: "size-2.5 rounded-full", style: { backgroundColor: a.color } }), _jsx("span", { className: "truncate text-sm font-medium text-slate-700", children: a.areaName }), _jsx("span", { className: "text-sm font-bold text-slate-900", children: fmt(a.employeeCount) }), _jsxs("span", { className: "text-[11px] font-semibold text-slate-500", children: [a.pct.toFixed(1), "%"] })] }, a.areaName)) })] })] }), _jsxs(Card, { className: "border-slate-200 min-h-[360px]", children: [_jsx(CardHeader, { className: "pb-2", children: _jsxs(CardTitle, { className: "flex items-center justify-between text-slate-800", children: [_jsxs("span", { className: "flex items-center gap-2", children: [_jsx(Clock3, { className: "size-4 text-blue-600" }), "Resumen de asistencia"] }), _jsx("span", { className: "rounded-md bg-slate-100 px-2 py-1 text-[11px] font-semibold text-slate-600", children: "Hoy" })] }) }), _jsxs(CardContent, { className: "space-y-3", children: [_jsx("div", { className: "grid gap-2 sm:grid-cols-2", children: [{ n: "Tardanzas hoy", v: fmt(attendance?.late), c: "text-emerald-700 border-emerald-100 bg-emerald-50", t: "emerald" }, { n: "Faltas hoy", v: fmt(attendance?.absent), c: "text-rose-700 border-rose-100 bg-rose-50", t: "rose" }, { n: "Permisos activos", v: fmt(analytics?.pendingLeaves), c: "text-blue-700 border-blue-100 bg-blue-50", t: "blue" }, { n: "Ausencias", v: fmt((attendance?.noRecord ?? 0) + (attendance?.justified ?? 0)), c: "text-violet-700 border-violet-100 bg-violet-50", t: "violet" }].map((x) => (_jsxs("div", { className: `rounded-xl border p-3 ${x.c}`, children: [_jsx("p", { className: "text-[11px] font-semibold", children: x.n }), _jsx("p", { className: "mt-1 text-3xl font-extrabold", children: x.v }), _jsx(MiniSpark, { tone: x.t })] }, x.n))) }), _jsxs("div", { className: "grid gap-2 rounded-xl border border-slate-100 bg-slate-50 px-3 py-2.5 sm:grid-cols-3", children: [_jsxs("div", { children: [_jsx("p", { className: "text-[11px] text-slate-500", children: "Asistencia promedio" }), _jsx("p", { className: "text-lg font-extrabold text-emerald-700", children: safePercent(analytics?.attendanceRate) })] }), _jsxs("div", { children: [_jsx("p", { className: "text-[11px] text-slate-500", children: "Mejor indicador" }), _jsx("p", { className: "text-lg font-extrabold text-blue-700", children: safePercent(100 - (analytics?.lateRate ?? 0)) })] }), _jsxs("div", { children: [_jsx("p", { className: "text-[11px] text-slate-500", children: "Pendientes hoy" }), _jsx("p", { className: "text-lg font-extrabold text-violet-700", children: fmt(totalPending) })] })] })] })] })] }), _jsxs(Card, { className: "border-slate-200", children: [_jsx(CardHeader, { className: "pb-2", children: _jsx(CardTitle, { className: "text-slate-800", children: "Accesos rapidos" }) }), _jsxs(CardContent, { className: "grid gap-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6", children: [_jsx(ActionTile, { to: "/app/employees", label: "Nuevo empleado", icon: UserPlus }), _jsx(ActionTile, { to: "/app/attendance", label: "Registrar asistencia", icon: Clock3 }), _jsx(ActionTile, { to: "/app/vacations", label: "Aprobar vacaciones", icon: CalendarDays }), _jsx(ActionTile, { to: "/app/payroll", label: "Ver planilla", icon: FileText }), _jsx(ActionTile, { to: "/app/reports", label: "Ver reportes", icon: ClipboardList }), _jsx(ActionTile, { to: "/app/configuration", label: "Configuracion", icon: Settings })] })] })] }));
}
